...
burger = Recipe.new("Cheeseburger", ["ground beef", "cheese", "buns"], ["form ground beef into patties", "grill patties", "place cheese on patties", "place in buns"] )
...
mex_cuisine.submit_recipe

mex_cuisine.print_cookbook
mex_cuisine.search_ingredients